...
class Params:
    ...
    def __init__(self, project_name: str, params_in=None):
        """
...
def new_mc2_yaml(args):
    ...
    mc2_yaml_dict = {
        ...
        "MC2": {
            ...
            "desired_pixel_size": args.pixel_size * 2
            if args.super_res
            else args.pixel_size,
...
def new_ctffind_yaml(args):
    ...
    ctf_yaml_dict = {
        ...
        "ctffind": {
            ...
            "astigm_restraint": args.astigm_restraint
            if args.astigm_restraint > 0
            else False,
...
def new_align_yaml(args):
    ...
    align_yaml_dict = {
        "System": {
            ...
            "output_path": str(args.output_folder),
            "output_rootname": args.file_prefix
            if args.file_prefix != ""
            else args.project_name,
    ...
    recon_yaml_dict = {
        ...
        "BatchRunTomo": {
            ...
            "reconstruction": {
                ...
                "use_sirt": args.use_sirt,
                "sirt_iter": args.sirt_iter,
            },
            "postprocessing": {
                "run_trimvol": args.trimvol,
...
def new_savurecon_yaml(args):
    ...
    savurecon_yaml_dict = {
        "System": {
            ...
            "output_rootname": args.project_name.value
            if args.rootname.value is None
            else args.rootname.value,
...
def new_aretomo_yaml(args):
    ...
    aretomo_yaml_dict = {
        "System": {
            ...
            "output_rootname": args.project_name
            if args.rootname == ""
            else args.rootname,
...
def read_yaml(project_name: str, filename: str):
    """
